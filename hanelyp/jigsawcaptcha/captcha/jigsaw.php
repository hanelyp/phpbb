...
namespace hanelyp\jigsawcaptcha\captcha;
...
* @package VC
*/
class jigsaw extends \hanelyp\jigsawcaptcha\captcha\captcha_more_abstract
{
	...
	var $template = '@hanelyp_jigsawcaptcha/captcha_jigsaw.html';
	
	function init($type)
	{
		global $config, $db, $user;
		parent::init($type);
		$user->add_lang_ext('hanelyp/jigsawcaptcha', 'captcha_jigsaw');
	}
	...
	// render the image
	function render_image($code, $seed)
	{
	...
	function get_name()
	{
		...
		return 'Jigsaw Puzzle Captcha';
	}

	function get_class_name()
	{
		return 'hanelyp.jigsawcaptcha.captcha.jigsaw';
	}
	...
	function get_demo_template($id)
	{
		...
		return '@hanelyp_jigsawcaptcha/captcha_jigsaw_acp_demo.html';
	}
	...
	function acp_page($id, &$module)
	{
		...
		$module->tpl_name = '@hanelyp_jigsawcaptcha/captcha_jigsaw_acp';
